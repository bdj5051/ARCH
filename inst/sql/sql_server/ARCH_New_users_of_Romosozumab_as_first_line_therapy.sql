...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1511251)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1511251)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44506794,1513103,1436678,36850663,1521987,1594148,1557272,1516800,1552929,1578445,1524674,1512480,1511646,40222444)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (44506794,1513103,1436678,36850663,1521987,1594148,1557272,1516800,1552929,1578445,1524674,1512480,1511646,40222444)
  and c.invalid_reason is null
...
WHERE YEAR(E.start_date) - P.year_of_birth > 50 AND P.gender_concept_id in (8532)
